...
class Helper_Functions {
    ...
    */
    ...
    /**
     * Get coupon by coupon code url override.
     *
     * @since 1.0.1
     * @access public
     *
     * @param string $code_override Code url override.
     * @return mixed stdClass coupon object if sql return a result, false otherwise.
     */
    public function get_coupon_by_code_url_override( $code_override ) {

        global $wpdb;

        $query = "SELECT * FROM $wpdb->posts AS posts_table
                  ...
                  AND post_meta_table.meta_key = '" . Plugin_Constants::COUPON_CODE_URL_OVERRIDE . "'
                  AND post_meta_table.meta_value = '" . $code_override . "'
                  LIMIT 1";
