...
This URL Coupons plugin has been replaced with our new, all powerful, coupon extension for WooCommerce called "[Advanced Coupons](https://advancedcouponsplugin.com/?utm_source=WordPressOrg&utm_medium=URLCouponsPlugin&utm_campaign=PluginListing)".

While this URL Coupons plugin will work and has some great features we recommend you check out it's replacement plugin as it lets you do much more like auto-apply coupons, BOGO deals, cart condition checking, notifications, and much much more.

[See All Features →](https://advancedcouponsplugin.com/?utm_source=WordPressOrg&utm_medium=URLCouponsPlugin&utm_campaign=PluginListing)
...
The URL Coupons For WooCommerce plugin was brought to you by the handsome folks over at [WooCommerce Advanced Coupons](https://advancedcouponsplugin.com/?utm_source=WordPressOrg&utm_medium=URLCouponsPlugin&utm_campaign=PluginListing). The makers of the worlds best coupon extension for WooCommerce.
